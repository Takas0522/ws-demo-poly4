...
class ConfigurationRepository:
    ...
    async def create(self, config: Configuration) -> Configuration:
        ...
        try:
            ...
            result = self.container.create_item(body=config_dict)
    ...
    async def find_by_id(self, config_id: str, tenant_id: str) -> Optional[Configuration]:
        ...
        try:
            result = self.container.read_item(item=config_id, partition_key=tenant_id)
            return Configuration(**result)
        except Exception as e:
    ...
    async def find_by_key(self, key: str, tenant_id: str) -> Optional[Configuration]:
        ...
        try:
            ...
            parameters = [{"name": "@key", "value": key}, {"name": "@tenant_id", "value": tenant_id}]
    ...
    async def update(
        ...
        try:
            ...
            result = self.container.replace_item(item=config_id, body=updated_dict)
    ...
    async def delete(self, config_id: str, tenant_id: str) -> None:
        ...
        try:
            self.container.delete_item(item=config_id, partition_key=tenant_id)
